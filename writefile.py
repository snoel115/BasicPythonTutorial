...
fob=open('C:/Users/Snoel/Desktop/p.txt', 'w') #if the file does not exists, it will be created
...
fob=open('C:/Users/Snoel/Desktop/p.txt', 'r')
...
#read the file in a list
fob=open('C:/Users/Snoel/Desktop/p.txt', 'a+') #a+ is appen and read
...
fob=open('C:/Users/Snoel/Desktop/p.txt', 'w')
